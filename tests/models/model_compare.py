...
def evaluate_ae(ae, signal_id, name, file_name):
    ae.plot_progress(title=name, file_name=file_name)
    ae.eval_model(signal_id=signal_id, name=name, file_name=file_name)
    ae.create_loss_distribution(signal_id=signal_id, name=name, file_name=file_name)
