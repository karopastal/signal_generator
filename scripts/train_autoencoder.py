...
# train_deep_ae = python_3_8_4 + ' -m src.analysis.models.create_deep_autoencoder'
train_conv_ae = python_3_8_4 + ' -m src.analysis.models.create_conv_autoencoder'
